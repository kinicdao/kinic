...
export const canisterId = process.env.CANDB_SERVICE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./candb_service.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the candb_service canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./candb_service.did.js")._SERVICE>}
 */
export const candb_service = createActor(canisterId);
