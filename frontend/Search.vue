      ...
      <div class="flex items-center justify-between flex-wrap">
        <div class="w-0 flex-1 flex flex-col items-left">
          <p class="ml-3 text-lg truncate headerSN">
            <span><b>Kinic</b> is the world's first web3 search engine. <a class="cursor-pointer text-white underline" @click="whitepaper">Read our SNS Whitepaper.</a></span>
          </p>
        </div>
        <div class="order-3 mb-1 flex-shrink-0 w-full sm:order-2 sm:mt-0 sm:w-auto">
            ...
            <div class="flex flex-row mt-1 w-full mx-auto justify-end items-end ml-auto">
                <a v-if="!isAlpaTest" @click="toggleAlphaTest()" class="cursor-pointer flex items-center justify-center px-4 py-3 rounded-md shadow-sm text-sm text font-bold text-white bg-black mt-1">
                  Try Alpha Mode
                </a>
                <a v-else @click="toggleAlphaTest()" class="cursor-pointer flex items-center justify-center px-4 py-3 rounded-md shadow-sm text-sm text font-bold text-white bg-black mt-1">
...
export default {
  ...
  methods: {
    ...
    toggleAlphaTest () {
      this.isAlpaTest = !this.isAlpaTest;    
    },
